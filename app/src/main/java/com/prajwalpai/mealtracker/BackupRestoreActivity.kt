...
import com.prajwalpai.mealtracker.backup.BackupManager
...
class BackupRestoreActivity : AppCompatActivity() {
    ...
    private fun showRestoreConfirmDialog(backupData: com.prajwalpai.mealtracker.backup.BackupData) {
        val stats = backupManager.getBackupStats(backupData)
    ...
    private fun confirmRestore(backupData: com.prajwalpai.mealtracker.backup.BackupData, clearExisting: Boolean) {
    ...
    private fun executeRestore(backupData: com.prajwalpai.mealtracker.backup.BackupData, clearExisting: Boolean) {
        lifecycleScope.launch {
            try {
                restoreBackupButton.isEnabled = false
                restoreBackupButton.text = "Restoring..."
    ...
    private fun showBackupSuccessDialog(stats: com.prajwalpai.mealtracker.backup.BackupStats) {
        val dateFormat = SimpleDateFormat("MMM dd, yyyy 'at' h:mm a", Locale.getDefault())
