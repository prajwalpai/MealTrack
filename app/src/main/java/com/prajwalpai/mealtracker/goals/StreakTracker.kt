...
class StreakTracker(context: Context) {
     ...
     */
    private suspend fun updateHealthyMealsStreak(date: String, meals: List<com.prajwalpai.mealtracker.Meal>) {
     ...
     */
    private suspend fun updateAllMealsLoggedStreak(date: String, meals: List<com.prajwalpai.mealtracker.Meal>) {
     ...
     */
    private suspend fun updateNoJunkStreak(date: String, meals: List<com.prajwalpai.mealtracker.Meal>) {
     ...
     */
    private suspend fun updatePerfectDayStreak(date: String, meals: List<com.prajwalpai.mealtracker.Meal>) {
        val mealTypes = meals.map { it.type }.toSet()
        val allTypesLogged = mealTypes.containsAll(
            listOf("Breakfast", "Lunch", "Evening Snacks", "Dinner")
        )
